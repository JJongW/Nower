...
//  (앱 타깃마다 이중 정의되던 것을 NowerCore 단일 정의로 승격.)
...
public enum RecurringEventExpander {
    ...
    public static func occurrence(of todo: TodoItem, on date: Date) -> TodoItem? {
    ...
    public static func occurrences(of todo: TodoItem, from: Date, to: Date) -> [TodoItem] {
        guard let info = todo.recurrenceInfo,
